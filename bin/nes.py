...
class Algo(EvoAlgo):
    ...
    def run(self):
        ...
        while self.steps < self.maxsteps:
            ...
            self.mu = torch.tensor(self.center, requires_grad=True)

            p = Normal(self.mu, self.noiseStdDev)

            pop = p.sample(n=self.batchSize)
            ...
            mean = expectation(self.fitnesses, pop, p=p)
