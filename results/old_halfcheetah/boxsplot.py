...
openai_es = [2586.61, 1771.13, 2501.58, 2721.62, 2551.22, 2469.41, 2611.83, 1736.72, 2188.47, 1501.99]
...
data = [openai_es, n2_ninhes_85gen, n3_ninhes_81gen, n3_ninhes_85gen, n5_ninhes_85gen, same_seed, brenda_arthur]

fig, ax = plt.subplots()
ax.boxplot(data)

ax.set_xticklabels(['OpenAi-Es', '2-85', '3-81', '3-85', '5-85', 'Same seed', 'Brenda'])
